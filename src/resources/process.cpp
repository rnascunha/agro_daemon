					...
					std::error_code& ec) noexcept
{
	...
	Websocket<false>::write_all(Message::device_status_to_json(dev));
					...
					std::error_code& ec) noexcept
{
	...
	Websocket<false>::write_all(Message::device_route_to_json(dev));
					...
					std::error_code& ec) noexcept
{
	...
	Websocket<false>::write_all(Message::device_board_to_json(dev));
					...
					std::error_code& ec) noexcept
{
	...
	Websocket<false>::write_all(Message::device_config_to_json(dev));
					...
					std::error_code& ec) noexcept
{
	...
	Websocket<false>::write_all(Message::device_full_config_to_json(dev));
					...
					std::error_code& ec) noexcept
{
	...
	Websocket<false>::write_all(Message::device_sensor_data_to_json(dev));
